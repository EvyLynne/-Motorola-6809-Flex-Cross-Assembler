// TODO: Locate definition for mapdn()
//  TODO: Link files using #include directives
// There are DEBUG statements that can be turned on using preprocessor directives
...
char    **argv;
{
        ...
        if(argc < 2){
          ...
          Argv = argv;
          // TODO : PROTOTYPE THIS FUNCTION - DEFINITION BELOW
          initialize();
          while ( (j<argc) && (*argv[j] != '-') )
           j++;
          N_files = j-1;
        ...
        if( Err_count == 0 ){
            ...
            // TODO: loop to go through each file .... clean this up
